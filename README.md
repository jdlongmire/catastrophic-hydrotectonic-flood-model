...
| | |
|---|---|
| **Core commitment** | No deep-time entailment; Genesis records real historical events (creation, Fall, Flood); the Flood was a real historical global catastrophe; creation was deployed functionally mature (DFM); natural law is stable from the close of the catastrophe forward |
