...
**What remains open:** $H$/$E_G$'s actual job — the discordant, reset, and mixed-domain population — still needs its discriminator checked for evaluability (a defined, testable dataset) and its rival (mainstream discordia/Pb-loss/resetting-age interpretation) steelmanned before this is more than a research direction. See the dev-note's Open section.
