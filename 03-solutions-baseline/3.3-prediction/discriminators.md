...
**The concession lives in the companion paper: Lee, J. (2021), "Giant Gorges, Colossal Canyons and Vast Valleys: Evaluating Mechanisms of Formation for a Set of Large-Scale Transverse Drainages," SSRN 3980591.** It evaluates four mechanisms — **antecedence, superimposition, piracy/capture, and overflow** — and notes "a major misconception about the power of headward eroding streams that has dogged scholarship." Supporting statements from the wider geomorphology literature: transverse drainages are "conspicuous geomorphic elements in mountain ranges of all ages, with each such stream and breached structure presenting a geomorphic problem," and theory here "has been slow to progress." Confidence **MEDIUM** — **full text not obtained**; SSRN, ResearchGate, and the Douglass et al. (2009) *GSA Bulletin* PDF all returned HTTP 403. Retrieving Lee 2021 in full is the first outstanding task, and rule 12's first condition is **not yet firmly established** until it is.
