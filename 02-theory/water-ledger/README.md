...
`forbids: none` — **belt/interpretive content** per [`research-practices.md`](../../00-program-methods/research-practices.md) rule 10. Discriminator candidate flagged at the end, not registered.
