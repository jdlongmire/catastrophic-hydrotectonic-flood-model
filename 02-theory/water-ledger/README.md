...
Belt content: a three-reservoir water-mass balance (ocean, surface/crustal, deep mantle) conserved across pre-Flood, Flood-year, and present states, without requiring a different total terrestrial water inventory than observed today — only a different partitioning.
